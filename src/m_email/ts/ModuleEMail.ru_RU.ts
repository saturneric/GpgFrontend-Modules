...
<context>
    ...
    <message>
        ...
        <translation>TLS (рекомендуется)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Нет (только этот компьютер)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Получение (IMAP)</translation>
    </message>
    <message>
        <location filename="../EMailAccountSettingsPage.cpp" line="148"/>
        <source>Sending (SMTP)</source>
        <translation>Отправка (SMTP)</translation>
    </message>
    <message>
        <location filename="../EMailAccountSettingsPage.cpp" line="155"/>
        <source>Use this account to receive</source>
        <translation>Использовать эту учётную запись для получения</translation>
    </message>
    <message>
        <location filename="../EMailAccountSettingsPage.cpp" line="155"/>
        <source>Use this account to send</source>
        <translation>Использовать эту учётную запись для отправки</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Определяется автоматически</translation>
    </message>
    <message>
        <location filename="../EMailAccountSettingsPage.cpp" line="203"/>
        <source>Sent folder</source>
        <translation>Папка отправленных</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Учётная запись, которая предлагается первой при отправке и используется, если не выбрана другая.</translation>
    </message>
    <message>
        <location filename="../EMailAccountSettingsPage.cpp" line="307"/>
        <source>No mail accounts yet</source>
        <translation>Пока нет почтовых учётных записей</translation>
    </message>
    <message>
        ...
        <translation>Учётная запись нужна только для получения и отправки сообщений. Всё остальное в GpgFrontend работает и без неё.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Оставьте пустым, чтобы сохранить прежний пароль</translation>
    </message>
    <message>
        ...
        <translation>Вход через собственную веб-страницу провайдера (OAuth2) пока не поддерживается. Если ваш провайдер требует такой вход, создайте пароль для приложения и используйте его здесь.</translation>
    </message>
    <message>
        <location filename="../EMailAccountSettingsPage.cpp" line="429"/>
        <source>Mail Accounts Not Saved</source>
        <translation>Почтовые учётные записи не сохранены</translation>
    </message>
    <message>
...
Your accounts are still there. Use the newer version to edit them.</source>
        <translation>Эти учётные записи были созданы более новой версией GpgFrontend, поэтому эта версия не прочитала их и не изменяла их.

Ваши учётные записи по-прежнему на месте. Используйте более новую версию, чтобы отредактировать их.</translation>
    </message>
    <message>
...
Nothing has been lost. If this keeps happening, the stored list may need to be removed by hand.</source>
        <translation>Не удалось прочитать сохранённые почтовые учётные записи, поэтому эта версия не изменяла их.
...
Его сохранённый пароль также будет удалён. Это действие нельзя отменить после нажатия OK в этом диалоге.</translation>
    ...
    <message>
        ...
        <translation>Другой аккаунт уже использует этот адрес. Их нельзя различить там, где предлагаются аккаунты.</translation>
    </message>
    <message>
...
Trust this exact certificate for this account? Any other certificate, including a later replacement of this one, will still be refused.</source>
        <translation>Этот сервер представил сертификат, за который не ручается ни один удостоверяющий центр. Это нормально для сервера, которым вы управляете сами, и именно так выглядит перехват.
...
<context>
    ...
    <message>
        ...
        <translation>Фильтр заголовков</translation>
    </message>
    <message>
        <location filename="../EMailHeaderView.cpp" line="79"/>
        <source>Show only the headers whose name or value contains this text.</source>
        <translation>Показывать только те заголовки, имя или значение которых содержит этот текст.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Копировать поле целиком</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>В этом сообщении нет заголовков для отображения.</translation>
    </message>
</context>
<context>
...
Use Refresh to try again.</source>
        <translation>Не удалось открыть эту учётную запись: %1.
...
Нажмите «Обновить», чтобы повторить попытку.</translation>
    ...
    <message>
        ...
        <translation>Пароль для этой учетной записи не сохранен. Укажите его в настройках, в разделе «Учетные записи почты», затем нажмите «Повторить».</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Это сообщение больше, чем может открыть это приложение, поэтому его невозможно импортировать.</translation>
    </message>
    <message>
...
Если проблема сохраняется, обратитесь в службу технической поддержки или ознакомьтесь с документацией.</translation>
    ...
    <message>
        ...
        <translation>зашифровано для, не указано в заголовках</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>в %1, но не зашифровано для него: невозможно прочитать</translation>
    </message>
    <message>
...
The signature is discarded and the message becomes an ordinary, unsigned one. The message itself is kept exactly as it is. This cannot be undone.</source>
        <translation>Удалить подпись из этого сообщения?
...
This message itself has not been changed.</source>
    ...
    <message>
        ...
        <translation>Получатели не указаны, поэтому нельзя сказать, можно ли открыть это сообщение, пока не попробуете.</translation>
    </message>
    <message>
...
Remove the signature and make it an ordinary message?</source>
        <translation>Это сообщение подписано, поэтому его нельзя изменить: правка под подписью воспринимается как подделка.
...
%1</source>
        <translation>Ничего не прикреплено:
...
%1</source>
        <translation>Эти файлы не были прикреплены:
...
Save it instead, and open it yourself if you are sure of where it came from.</source>
        <translation>%1 — это не тот тип файлов, который эта программа может открыть, поскольку открытие означало бы его запуск или передачу программе, которая может его выполнить.
...
This message came from somewhere else, so unless these have been saved already this is the only copy. Removing them cannot be undone.</source>
        <translation>Удалить из этого сообщения:
...
%1</source>
        <translation>Сохранено. Некоторые имена в этой папке уже заняты, поэтому эти файлы сохранены под другими именами:
...
<context>
    ...
    <message>
        ...
        <translation>действителен, ключ не полностью доверенный</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>в сообщении указан %1, но в подписи использован %2</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>отправитель решил не указывать, кто это</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>в %1, но не зашифровано для него: они не смогут это прочитать</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Готово к отправке. Пока ничего не покинуло этот компьютер.</translation>
    </message>
    <message>
...
%1, %n вложений</numerusform>
    ...
    <message>
        ...
        <translation>Отправить через</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Эти адреса передаются только исходящему серверу. Они не отображаются в сообщении, поэтому их не видят другие получатели.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Покрыто</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Копировать Content-Type</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подписанная часть содержит окончания строк, отличные от CRLF, а это не та форма, для которой вычисляется подпись. Что-то переписало это сообщение после подписания, обычно программа, которая изменила окончания строк при сохранении или копировании, а не атака. Подпись не может быть проверена для этих байтов, и импорт ключа отправителя этого не изменит. Для проверки нужно исходное, неизменённое сообщение.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Домен в &quot;%1&quot; содержит символы, которые могут быть похожи на символы другого адреса. Проверьте адрес перед отправкой.</translation>
    </message>
    <message>
